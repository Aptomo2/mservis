...
<body>
      ...
      <form method="post">
         ...
         <div class="form">
            ...
            <div class="inputfield">
               ...
               <input type="number" class="input" name="biayatambahan"
                  placeholder="Rp. <?php echo $pecah_pemesanan['biaya_tambahan']; ?>">
            </div>

            <div class="inputfield">
               <label>Keterangan Biaya Tambahan</label>
               <textarea type="text" class="textarea" name="keterangan"
                  placeholder="<?php echo $pecah_pemesanan['keterangan']; ?>"> </textarea>
            </div>
            <div class="inputfield">
   ...
   if (isset($_POST["tambah"])) {
      $biayajasa = intval($_POST['biayajasa']);
      $biaya_tambahan = intval($_POST['biayatambahan']);
      $keterangan = $_POST['keterangan'];

      $total_biaya = $total_biaya_jasa + $biaya_tambahan;
