...
<body>
   ...
   $id_servis_pemesanan = $pecah['id_servis'];
   $id_cek_pemesanan = $pecah['id_cek'];
   $id_oli_pemesanan = $pecah['id_oli'];
   $id_spare_pemesanan = $pecah['id_sparepart'];
   ...
   <div class="wrapper">
      <div class="title">
         ...
         <p>No. Pesanan :
            <?php echo $pecah['id_pemesanan']; ?> | Status : <span>
               <?php echo $pecah['status_pemesanan']; ?>
            </span>
         </p>
      </div>
      <div class="form">
